...
from ..Module.cosmeticsmods.field2d import (
    CommandMenuRandomizer,
    RoomTransitionImageRandomizer,
)
...
def _starting_inventory_setting(
    key: str, name: str, item_type: itemType, max_number: int
) -> IntSpinner:
    return IntSpinner(
        name=key,
...
_all_settings = [
    ...
    _starting_inventory_setting(
        settingkey.STARTING_MAGIC_FIRE, "Fire", itemType.FIRE, 3
    ),
    _starting_inventory_setting(
        settingkey.STARTING_MAGIC_BLIZZARD, "Blizzard", itemType.BLIZZARD, 3
    ),
    _starting_inventory_setting(
        settingkey.STARTING_MAGIC_THUNDER, "Thunder", itemType.THUNDER, 3
    ),
    _starting_inventory_setting(
        settingkey.STARTING_MAGIC_CURE, "Cure", itemType.CURE, 3
    ),
    _starting_inventory_setting(
        settingkey.STARTING_MAGIC_MAGNET, "Magnet", itemType.MAGNET, 3
    ),
    _starting_inventory_setting(
        settingkey.STARTING_MAGIC_REFLECT, "Reflect", itemType.REFLECT, 3
    ),
    _starting_inventory_setting(
        settingkey.STARTING_PAGES, "Torn Page", itemType.TORN_PAGE, 5
    ),
    MultiSelect(
        name=settingkey.STARTING_KEYBLADES,
        group=SettingGroup.STARTING_INVENTORY,
        ui_label="Starting Keyblades",
        choices={str(k.id): k.name for k in get_all_keyblades()},
        shared=True,
        default=[],
    ...
    MultiSelect(
        ...
        choices={
            ...
            for item in Items.sort_ability_items(
    ...
    MultiSelect(
        ...
        choices={
            str(item.Id): item.Name
            for item in Items.sort_ability_items(Items.getActionAbilityList())
        },
        shared=True,
        default=[],
        tooltip="Selected abilities may randomize onto keyblades. Unselected abilities will not be on keyblades.",
    ...
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_SP, location=locationType.SP
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_PR, location=locationType.PR
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_TT, location=locationType.TT
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_OC, location=locationType.OC
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_HT, location=locationType.HT
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_LOD, location=locationType.LoD
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_TWTNW, location=locationType.TWTNW
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_BC, location=locationType.BC
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_AG, location=locationType.Agrabah
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_PL, location=locationType.PL
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_HB, location=locationType.HB
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_DC, location=locationType.DC
    ),
    _location_unlock_setting(
        key=settingkey.STARTING_UNLOCKS_STT, location=locationType.STT
    ),
    Toggle(
    ...
    _weighted_item_setting(
        key=settingkey.WEIGHTED_PROMISE_CHARM, item_type="Promise Charm"
    ),
    Toggle(
