...
from .configDict import itemRarity
...
from .inventory.ability import DonaldAbilities, GoofyAbilities, Ability
from .inventory.keyblade import Keyblade
...
class Items:
    ...
    @staticmethod
    def getItemList(
        story_unlocking_rarity: itemRarity = itemRarity.UNCOMMON,
    ) -> list[KH2Item]:
        return [
    ...
    def getStatItems() -> list[KH2Item]:
        ...
        return (
            list(itertools.repeat(KH2Item(bonus.MaxHpUp), 20))
            ...
            + list(
                itertools.repeat(KH2Item(bonus.AccessorySlotUp, itemRarity.UNCOMMON), 3)
            )
    ...
    def getFormToDummyMap() -> dict[int, int]:
        return {
            form.ValorForm.id: form.DummyValorForm.id,
